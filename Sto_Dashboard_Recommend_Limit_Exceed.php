            ...
            $sto_recommend_lie_count = sto_with_in_limit_qry('2','recommendation_limit_exceed');
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-3 col-md-6">
                                    <table class="table table-bordered table-hover table-striped datatable widget-shade" style="height: 105px !important;">
                                        ...
                                        <tbody>
                                            <?php foreach ($sto_recommend_lie_count as $key => $value) { ?>
                                            <tr>
                                                <td class="v-middle"><a href="Sto_Recommend_Sales_Indent_Report.php?filter=<?php echo base64_encode($value['Plant_Code']); ?>"><h5><span class="badge bg-primary"><?php echo $value['Plant_Code']; ?></span><i class="fas fa-angle-double-right text-primary ms-2 blink_anime"></i></h5></a></td>
            ...
            <script type="text/javascript">
                $(document).ready(function(){
                    $('.page-title').text('STO Recommendation (Limit Exceed)');
                    $('.page-title').before("<i class='fas fa-receipt icon font-size-17 me-2 text-primary'></i>");
