...
include '../auto_load.php';
	...
	$Dcode=$_SESSION['Dcode'];
	 ...
	 $sql="EXEC Sales_Indent_STO_Details_Limit_Exceed @Emp_Id='".$Emp_Id."',@Product_Division='".$ProductDivision."',@Dcode='".$Dcode."',@plant_id='".$Plant_Id."',@Zone_id='".$Zone_id."',@Region_Id='".$Region_Id."',@Terrirory_Id='".$Terrirory_Id."',@Status='3',@Length='$length',@Offset='$offset'";
	...
	{		
		if($prow['Validate_Permission_Limit_Exceed'] == 1){
