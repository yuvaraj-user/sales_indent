                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6" >
                                           <div class="card">
                                              <div class="card-body" id="containers4">
                                                    ...
                                                    <table class="table table-bordered table-hover dataTable table-striped w-full zone_wise_summary responsive" style="width:100%;">
                                                       <thead>
                                                          <th>Division</th>
                                        ...
                                        <div class="col-md-6" >
                                           <div class="card">
                                              <div class="card-body" id="containers4">
                                                    ...
                                                    <table class="table table-bordered table-hover dataTable table-striped w-full crop_wise_summary responsive" style="width:100%;">
                                                       <thead>
                                                          <th>Crop</th>
                                                          <th class="rgt" style="text-align: right;">Indent</th>
                                                          <th class="rgt" style="text-align: right;">Approved Indent</th>
                                        ...
                                        <div class="col-md-6 region_wise_summary_div" style="display:none">
                                           <div class="card">
                                              <div class="card-body" id="containers4">
                                                    ...
                                                    <table class="table table-bordered table-hover dataTable table-striped w-full region_wise_summary responsive" style="width:100%;">
                                                       <thead>
                                                          <th>Region</th>
                                                          <th class="rgt" style="text-align: right;">Indent</th>
                                                          <th class="rgt" style="text-align: right;">Approved Indent</th>
                                        ...
                                        <div class="col-md-6 vareity_wise_summary_div" style="display:none">
                                           <div class="card">
                                              <div class="card-body" id="containers4">
                                                    ...
                                                    <table class="table table-bordered table-hover dataTable table-striped w-full vareity_wise_summary responsive" style="width:100%;">
                                                       <thead>
                                                          <th>Variety</th>
                                                          <th class="rgt" style="text-align: right;">Indent</th>
                                                          <th class="rgt" style="text-align: right;">Approved Indent</th>
                                        ...
                                        <div class="col-md-6 territory_wise_summary_div" style="display:none">
                                           <div class="card">
                                              <div class="card-body" id="containers4">
                                                    <h5 class="card-header text-center report-head-bg mb-2 text-white">Territory Wise Summary</h5>
                                                    <table class="table table-bordered table-hover dataTable table-striped w-full territory_wise_summary responsive" style="width:100%;">
                                                       <thead>
                                                          <th>Territory</th>
                                                          <th class="rgt" style="text-align: right;">Indent</th>
                                                          <th class="rgt" style="text-align: right;">Approved Indent</th>
            ...
            <script src="js/SalesIntentSummaryReport.js"></script>
            <script src="../common/checkSession.js"></script>

            <script type="text/javascript">
                $(document).ready(function(){
                    $('.page-title').text('Indent VS Actual');
                    $('.page-title').before("<i class='far fa-file-alt icon font-size-17 me-2 text-primary'></i>");
