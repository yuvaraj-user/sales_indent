 ...
 jQuery.fn.DataTable.Api.register( 'buttons.exportData()', function ( options ) {
   if ( this.context.length ) {
     var jsonResult = $.ajax({
       ...
       type:'POST',
       dataType:'json',
       "data": {Action:'Approve_Details_For_With_In_Limit',Zone_id:user_input.zone_id,Region_Id:user_input.region_id,Terrirory_Id:user_input.teritory_id,Supply_Type:user_input.supply_type,length:'All'},
       async: false
     });
...
$('#' + data_table).DataTable({
  ...
  "ajax": 
  {
    "url": "Ajax.php", 
    "type": "POST",
    "data": {Action:'Approve_Details_For_With_In_Limit_Direct',Zone_id:user_input.zone_id,Region_Id:user_input.region_id,Terrirory_Id:user_input.teritory_id,Supply_Type:user_input.supply_type}
  },
