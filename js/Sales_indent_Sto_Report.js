$(document).on("submit",".adv_submit",function(){
	...
	// console.log(user_input.zone_id);
...
jQuery.fn.DataTable.Api.register( 'buttons.exportData()', function ( options ) {
      ...
      "url": "Sto_Sales_Indent_Data_Table_Details.php", 
                         type:'POST',
                         dataType:'json',
                         "data": {ProductDivision:user_input.product_division,QuotationType:user_input.quot_type,SaleOrderType:user_input.sale_type,Zone_id:user_input.zone_id,Region_Id:user_input.region_id,Terrirory_Id:user_input.teritory_id,Plant_Id:user_input.plant_id
        ,Status:user_input.Status,length:"All"},
                         async: false,
                     });
      
                  
                     let headers=['S.No','ReqId','Req Date','RequestBy','EMPLNAME','Product Division','Crop','Zone','Region','Plant Id','Material Code','Quantity InBag','Quantity InPKt','Quantity InKg','Status'];
