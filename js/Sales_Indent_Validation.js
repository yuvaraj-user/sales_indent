...
return Count;
  ...
  $(document).on("click",".submit_btn",function(){
   ...
   //user_input.supply_type=$(".supply_type").val();
   var Qty_Validation=Check_Qty_Validation();
   if(Qty_Validation == 0){
	  $.ajax 
      ({
      type: "POST",
      ...
      success: function(data){
         ...
         if(result.Status == 1){
			Alert_Msg("Validated Successfully.","success");
...
jQuery.fn.DataTable.Api.register( 'buttons.exportData()', function ( options ) {
       ...
       url: 'Ajax.php',
                         type:'POST',
                         dataType:'json',
                          "data": {Action:'Validation_Details_For_Limit_Exceed',Zone_id:user_input.zone_id,Region_Id:user_input.region_id,Terrirory_Id:user_input.teritory_id,Supply_Type:user_input.supply_type,length:'All'},
                         async: false
                     });
...
let example =  $('#' + data_table).DataTable({
    ...
    "ajax": 
    {
      "url": "Ajax.php", 
      "type": "POST",
      "data": {Action:'Validation_Details_For_Limit_Exceed',Zone_id:user_input.zone_id,Region_Id:user_input.region_id,Terrirory_Id:user_input.teritory_id,Supply_Type:user_input.supply_type}
    },
