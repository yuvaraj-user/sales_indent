...
let example =  $('#' + data_table).DataTable({
  ...
  "ajax": 
  {
    "url": "Ajax.php", 
    "type": "POST",
    "data": {Action:'Sales_Indent_Validation_With_In_Limit',Zone_id:user_input.zone_id,Region_Id:user_input.region_id,Terrirory_Id:user_input.teritory_id,Supply_Type:user_input.supply_type}
  }
});
