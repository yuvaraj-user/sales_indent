...
function post_data_to_sap(datas)
{
  ...
  var url = "http://182.18.162.108:8081/Sales_Indent/"+ Sap_url +"/ZIN_RFC_ERAIN_UPDATE_QUOT_DAS.php";
   // var url = "http://182.18.162.108:8081/Sales_Indent/PRD/ZIN_RFC_ERAIN_UPDATE_QUOT_DAS.php";
   $.ajax ({
        method: "POST",
  ...
  $(document).on("click",".submit_btn",function(){
    ...
    // var postData = $(".sales_indent_validate").serialize()+'&Statement_Type=Approved&supply_type_id='+$(".supply_type").val()+'&Limit_Exceed=1';
	  var user_input={};
...
Server_Side_Datatable("yes",user_input);
  ...
  $(document).on("change",".supply_type",function(){
    get_plant_details($(this).val(),0);
     ...
     user_input.region_id=$(".region_id").val();
     user_input.teritory_id=$(".territory_id").val();
     user_input.supply_type=$(this).val();
     Server_Side_Datatable("yes",user_input);
  });
   ...
   function Server_Side_Datatable(destroy_status,user_input)
{
  ...
  jQuery.fn.DataTable.Api.register( 'buttons.exportData()', function ( options ) {
       ...
       url: 'Ajax.php',
                         type:'POST',
                         dataType:'json',
                          "data": {Action:'Approve_Details_For_With_Limit_Exceed',Zone_id:user_input.zone_id,Region_Id:user_input.region_id,Terrirory_Id:user_input.teritory_id,Supply_Type:user_input.supply_type,length:'All'},
                         async: false
                     });
 ...
 $('#' + data_table).DataTable({
    ...
    "ajax": 
    {
      "url": "Ajax.php", 
      "type": "POST",
      "data": {Action:'Approve_Details_For_With_Limit_Exceed',Zone_id:user_input.zone_id,Region_Id:user_input.region_id,Terrirory_Id:user_input.teritory_id,Supply_Type:user_input.supply_type}
    }
  });
}