...
function Alert_Msg(Msg,Type){
 ...
 $(document).on("click",".checkAll",function(){
  	 ...
  	 $('.validate').not(this).prop('checked', this.checked);
       //alert("Hai");
  })


  $(document).on("click",".submit_btn",function(){
	  // var postData = $(".sales_indent_validate").serialize()+'&Statement_Type=Approve&Supply_Type='+$(".supply_type").val();
    var postData = $(".sales_indent_validate").serialize()+'&Statement_Type=Approve';
   ...
   user_input.product_division=$(".product_division").val();
      ...
      success: function(data){
         ...
         if(result.Status == 1){
			Alert_Msg("Recommended Successfully.","success");
    ...
    var postData = $(".sales_indent_validate").serialize()+'&Statement_Type=Reject&supply_type_id='+$(".supply_type").val();
    var user_input={};
    user_input.supply_type=$(".supply_type").val();
    user_input.zone_id=$(".zone_id").val();
   user_input.region_id=$(".region_id").val();
   ...
   //user_input.supply_type=$(".supply_type").val();
    ...
    function Validate_Limit_Exceeds(){
                 ...
                 if ( this.context.length ) {
                     var jsonResult = $.ajax({
                        ...
                        url: 'Ajax.php',
                         type:'POST',
                         dataType:'json',
                          "data": {Action:'Recommedation_Details_For_Limit_Exceed',Zone_id:user_input.zone_id,Region_Id:user_input.region_id,Terrirory_Id:user_input.teritory_id,Supply_Type:user_input.supply_type,ProductDivision : user_input.product_division,length:'All'},
                         async: false
                     });
...
let example =  $('#' + data_table).DataTable({
    ...
    "ajax": 
    {
      "url": "Ajax.php", 
      "type": "POST",
      "data": {Action:'Recommedation_Details_For_Limit_Exceed',Zone_id:user_input.zone_id,Region_Id:user_input.region_id,Terrirory_Id:user_input.teritory_id,Supply_Type:user_input.supply_type,ProductDivision : user_input.product_division}
    },
