                                        ...
                                        <div class="card list_module_card">
                                            <div class="card-body">
                                                                    ...
                                                                    <form class="form-horizontal form-label-left  adv_submit"  method="POST" >
                                                                        ...
                                                                        <div class="row align-items-end">
                                                                          ...
                                                                          <div class="col-md-2 change_select_width">
                                                                                ...
                                                                                <select class="js-example-basic-single col-xs-12 required_for_valid cls_teritory supply_type" name="supply_type" 
                                                                                        onchange="">
                                                ...
                                                <form class="sales_indent_validate" method="post">
                                                    ...
                                                    <input type="hidden" name="Action" value="Recommend_Material_Details">

                                                    <div class="approvals text-end">
                                                        <button type="button" name="submit"class="btn btn-success submit_btn" disabled><i class="bx bx-check me-1"></i> Recommend</button>
        ...
        <script src="js/Sales_Indent_Recommendation.js"></script>
