                                        ...
                                        <div class="card list_module_card">
                                            <div class="card-body">
                                                                        ...
                                                                        <div class="row align-items-end">
                                                                          ...
                                                                          <div class="col-md-2 change_select_width">
                                                                                ...
                                                                                <select class="js-example-basic-single col-xs-12 required_for_valid cls_teritory supply_type" name="supply_type" 
                                                                                    ...
                                                                                    <option value="1" selected>Direct Supply </option>
                                                                                </select>
                                                ...
                                                <form class="sales_indent_validate" method="post">
                                                    ...
                                                    <input type="hidden" name="Action" value="Approve_Material_Details_Direct">
  ...
  <input type="hidden" value ="<?=isset($_REQUEST['status']) && $_REQUEST['status']!="" ? safe_decode($_REQUEST['status']): "1" ?>" id="filter_status"/>
        ...
        <script src="js/Approve_Sales_Indent_Report_Direct.js"></script>
        <script src="../common/checkSession.js"></script>

        <script type="text/javascript">
            $(document).ready(function(){
                $('.page-title').text('Indent Approve (Direct)(With In Limit)');
                $('.page-title').before("<i class='fas fa-chart-pie icon font-size-20 me-2 text-primary'></i>");
