...
include '../auto_load.php';
	...
	$Dcode=$_SESSION['Dcode'];
	 ...
	 $sql="EXEC Sales_Indent_STO_Details_WIth_Limit_STO @Emp_Id='".$Emp_Id."',@Product_Division='".$ProductDivision."',@Dcode='".$Dcode."',@plant_id='".$Plant_Id."',@Zone_id='".$Zone_id."',@Region_Id='".$Region_Id."',@Terrirory_Id='".$Terrirory_Id."',@Status='5'";
	...
	{
		if($prow['Approve_Permission_With_In_Limit'] == 1){
			...
			$resarr[] 	= '<div class="form-check"> 
						   ...
						   <input class="form-control" type="hidden" name="DBM_MAIL_STATUS['.@$prow['Id'].']" value="No">
						    ...
						    <input type="hidden" class="form-control CropId" name="CropId['.@$prow['Id'].']" value="'.@$prow['CropId'].'">
						      ...
						      <input class="form-control" type="hidden" name="Expected_Date['.@$prow['Id'].']" value="'.date("Ymd",strtotime(@$prow['Expected_Date'])).'">
