                                    ...
                                    <div class="card-body">
                                        <?php if(@$Requestor_Menu_For_Sto_Indent >0) {  ?>
                                            <div class="text-end mb-3">
                                                <a href="STOindex.php"><button class="btn btn-warning"><i class="fas fa-solid fa-plus"></i> Add STO</button></a>
                                            </div>
                                        <?php }?>
                                        <div class="col-md-12">
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-md-2 col-sm-3 col-xs-6 change_select_width">
                                                                            ...
                                                                            <select class="js-example-basic-single col-xs-12 Status required_for_valid" error-msg="Plant Field is Required" name="Status" >
                                                                                ...
                                                                                <option value="5" <?=$Status== 5 ? "Selected" : ""?>>Rejected </option>
                                                                            </select>
