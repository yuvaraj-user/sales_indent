            ...
            $validation_counts = indent_limit_exceed_qry(3,'validate');
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-3 col-md-6 mt-1">
                                    <table class="table table-bordered table-hover table-striped datatable" style="height: 125px !important;">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td class="v-middle"><a href="Sales_Indent_Validation.php?filter=2"><h5><span class="badge bg-success">C&F</span><i class="fas fa-angle-double-right text-success ms-2 blink_anime"></i></h5></a></td>
                                                <td class="v-middle text-end"><?php echo $validation_counts[0]['validate_cf_count'] ; ?></td>
                                                <!-- <td class="v-middle text-end"><?php echo $validation_counts[0]['validate_cf_qty'] ; ?></td> -->
                                            </tr>
                                            <tr>
                                                <td class="v-middle"><a href="Sales_Indent_Validation.php?filter=1"><h5><span class="badge bg-success">DIRECT</span><i class="fas fa-angle-double-right text-success ms-2 blink_anime"></i></h5></a></td>
                                                <td class="v-middle text-end"><?php echo $validation_counts[0]['validate_direct_count'] ; ?></td>
                                                <!-- <td class="v-middle text-end"><?php echo $validation_counts[0]['validate_direct_qty'] ; ?></td> -->
                                            </tr>
                                        </tbody>
            ...
            <script type="text/javascript">
                $(document).ready(function(){
                    $('.page-title').text('Indent Validation (Limit Exceeds)');
                    $('.page-title').before("<i class='fas fa-shield-alt icon font-size-20 me-2 text-primary'></i>");
