            ...
            $sto_validate_lie_count = sto_with_in_limit_qry('3','validate_limit_exceed');
                               ...
                               <!--  <div class="col-xl-3 col-md-4">
                                ...
                                <div class="col-xl-3 col-md-6">
                                    <table class="table table-bordered table-hover table-striped datatable widget-shade" style="height: 105px !important;">
                                        ...
                                        <tbody>
                                            <?php foreach ($sto_validate_lie_count as $key => $value) { ?>
                                            <tr>
                                                <td class="v-middle"><a href="Sto_Validate_Sales_Indent_Report_limit_Exceed.php?filter=<?php echo base64_encode($value['Plant_Code']); ?>"><h5><span class="badge bg-primary"><?php echo $value['Plant_Code']; ?></span><i class="fas fa-angle-double-right text-primary ms-2 blink_anime"></i></h5></a></td>
            ...
            <script type="text/javascript">
                $(document).ready(function(){
                    $('.page-title').text('STO Validation (Limit Exceeds)');
