                                    ...
                                    <div class="card-body">
                                        <?php if(@$requeter_menu >0) {  ?>
                                            <div class="text-end mb-3">
                                                <a href="Indent_creation.php"><button class="btn btn-warning"><i class="fas fa-solid fa-plus"></i> Add</button></a>
                                            </div>
                                        <?php }?>
                                        <div class="col-md-12">
                                                                    ...
                                                                    <div class="row mt-4">
                                                                        ...
                                                                        <div class="col-md-2 col-sm-3 col-xs-6 change_select_width">
                                                                            ...
                                                                            <select class="js-example-basic-single col-xs-12 Status required_for_valid" error-msg="Plant Field is Required" name="Status" >
                                                                                ...
                                                                                <option value="6" <?=$Status== 6 ? "Selected" : ""?>>Waitting For Approve(Direct)(With In Limit) </option>
        ...
        <script src="js/sales_indent_report.js"></script>
