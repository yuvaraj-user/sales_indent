...
include '../auto_load.php';
	...
	$Dcode=$_SESSION['Dcode'];
	 ...
	 $sql="EXEC Sales_Indent_STO_Details_WIth_Limit_STO @Emp_Id='".$Emp_Id."',@Product_Division='".$ProductDivision."',@Dcode='".$Dcode."',@plant_id='".$Plant_Id."',@Zone_id='".$Zone_id."',@Region_Id='".$Region_Id."',@Terrirory_Id='".$Terrirory_Id."',@Status='2',@Length='$length',@Offset='$offset'";
	...
	{		
		if(@$prow['Recommend_Permission_Limit_Exceed'] == 1){
