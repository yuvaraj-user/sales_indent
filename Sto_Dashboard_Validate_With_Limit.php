            ...
            <?php 
            if(@$Approver_For_Sto_Indent == 0) {
                header('location: index.php');  
            }
            $sto_validate_wil_count = sto_with_in_limit_qry('1','validate_with_in_limit');
            ?>
            <style type="text/css">
                .dataTables_paginate {
            ...
            <div id="layout-wrapper">
                ...
                <?php 
                    ...
                    $Waiting_Approve_Count_With_In_Limit=@$fetch_wait['Waiting_Approve_Count_With_In_Limit'];
                    ...
                    $Waiting_Approve_Qty_With_In_Limit=@$fetch_wait['Waiting_Approve_Count_With_In_Limit'];
                        ...
                        <div class="container-fluid">
                            <div class="row">
                                ...
                                <div class="col-xl-3 col-md-6">
                                    <table class="table widget-shade table-bordered table-hover table-striped datatable" style="height: 105px !important;">
                                        ...
                                        <tbody>
                                            <?php foreach ($sto_validate_wil_count as $key => $value) { ?>
                                                <tr>
                                                    <td class="v-middle"><a href="Sto_Validate_Sales_Indent_Report_With_Limit.php?filter=<?php echo base64_encode($value['Plant_Code']); ?>"><h5><span class="badge bg-primary"><?php echo $value['Plant_Code']; ?></span><i class="fas fa-angle-double-right text-primary ms-2 blink_anime"></i></h5></a></td>
            ...
            <script type="text/javascript">
                $(document).ready(function(){
                    $('.page-title').text('STO Validate (With In Limit)');
                    $('.page-title').before("<i class='fas fa-money-check icon font-size-17 me-2 text-primary'></i>");
