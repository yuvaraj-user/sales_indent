                                                                        ...
                                                                        <div class="row align-items-end">
                                                                           ...
                                                                           <div class="col-md-2 change_select_width">
                                                                               <label for="col-md-3">Territory</label>
                                                                                <select class="js-example-basic-single col-xs-12 required_for_valid cls_teritory territory_id" name="teritory_id" onchange="">
                                                                                    <option value="">Select </option>
                                                                                </select>
                                                                            </div>
                                                                          <div class="col-md-2 change_select_width">
        ...
        <script src="js/Approve_Sales_Indent_Report.js"></script>
