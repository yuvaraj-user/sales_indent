                                                                   ...
                                                                   <th>Quantity In Kg</th>
                                                                    <th>
                                                                        ...
                                                                        <div class="form-check d-flex justify-content-center"> 
                                                                            <input class="form-check-input checkAll" name="checkAll" type="checkbox" value="">
                                                                        </div>
                                                                    </th>  
                                                                </tr>
                                                            </thead>
                                                    </table>
                                                    <input type="hidden" name="Action" value="Recommend_STO_Material_Details">
  ...
  <input type="hidden" value ="<?=isset($_REQUEST['status']) && $_REQUEST['status']!="" ? safe_decode($_REQUEST['status']): "1" ?>" id="filter_status"/>
        ...
        <script src="js/Sto_Recommend_Sales_Indent_Report.js"></script>
