                        ...
                        <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <form class="sales_indent_validate" method="post">
                                        <div class="card">
                                            <div class="card-body">
                                                <table  class="table table-bordered table-hover dataTable table-striped Sales_Table mt-3" id="Sales_Indent" >
                                                        <thead>
                                                            <tr>                
                                                                <th>S.No</th>
                                                                <th>ReqId</th>
                                                ...
                                                <input type="hidden" name="Action" value="Validate_Material_Details">

                                                <div class="approvals text-center">
  ...
  <input type="hidden" value ="<?=isset($_REQUEST['status']) && $_REQUEST['status']!="" ? safe_decode($_REQUEST['status']): "1" ?>" id="filter_status"/>
        ...
        <script src="js/Sales_Indent_Validation_With_In_Limit.js"></script>
        <script src="../common/checkSession.js"></script>

        <script type="text/javascript">
            $(document).ready(function(){
                $('.page-title').text('Indent Validation (With In Limit)');
