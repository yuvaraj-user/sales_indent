            ...
            $sto_approve_wil_count = sto_with_in_limit_qry('5','approve_with_in_limit');
            ...
            <div id="layout-wrapper">
                ...
                <?php 
                    ...
                    // echo  $dashboard_det="EXEC Sales_Indent_STO_Widget_Count_Details @Emp_Id='".$_SESSION['EmpID']."',@Dcode='".$_SESSION['Dcode']."'";
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-3 col-md-6">
                                    <table class="table table-bordered table-hover table-striped datatable widget-shade" style="height: 105px !important;">
                                        ...
                                        <tbody>
                                            <?php foreach ($sto_approve_wil_count as $key => $value) { ?>
                                            <tr>
                                                <td class="v-middle"><a href="Sto_Approve_Sales_Indent_Report.php?filter=<?php echo base64_encode($value['Plant_Code']); ?>"><h5><span class="badge bg-primary"><?php echo $value['Plant_Code']; ?></span><i class="fas fa-angle-double-right text-primary ms-2 blink_anime"></i></h5></a></td>
            ...
            <script type="text/javascript">
                $(document).ready(function(){
                    $('.page-title').text('STO Approve (With In Limit)');
                    $('.page-title').before("<i class='fas fa-ribbon icon font-size-17 me-2 text-primary'></i>");
