            ...
            $with_in_limit_approve_count = indent_with_in_limit_qry('1');
            ?>
                                ...
                                <div class="col-md-4 col-xl-3">
                                 ...
                                 <div class="col-xl-3 col-md-6 mt-1">
                                    <table class="table table-bordered table-hover table-striped datatable widget-shade" style="height: 125px !important;">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td class="v-middle"><a href="Approve_Sales_Indent_Report.php?filter=2"><h5><span class="badge bg-success">C&F</span><i class="fas fa-angle-double-right text-success ms-2 blink_anime"></i></h5></a></td>
                                                <td class="v-middle text-end"><?php echo $with_in_limit_approve_count[0]['approve_cf_count'] ; ?></td>
                                                <!-- <td class="v-middle text-end"><?php echo $with_in_limit_approve_count[0]['approve_cf_qty'] ; ?></td> -->
                                            </tr>
                                            <tr>
                                                <td class="v-middle"><a href="Approve_Sales_Indent_Report.php?filter=1"><h5><span class="badge bg-success">DIRECT</span><i class="fas fa-angle-double-right text-success ms-2 blink_anime"></i></h5></a></td>
                                                <td class="v-middle text-end"><?php echo $with_in_limit_approve_count[0]['approve_direct_count'] ; ?></td>
                                                <!-- <td class="v-middle text-end"><?php echo $with_in_limit_approve_count[0]['approve_direct_qty'] ; ?></td> -->
                                            </tr>
                                        </tbody>
            ...
            <script type="text/javascript">
                $(document).ready(function(){
                    ...
                    $('.page-title').before("<i class='bx bx-check-shield icon font-size-20 me-2 text-primary'></i>");
